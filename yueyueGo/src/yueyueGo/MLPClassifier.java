...
public class MLPClassifier extends NominalClassifier {
	...
	//6. HS300 2008-2016 10单元格10%  20格8%；中证500 20/30/50  9%-11%; 全市场20/30/50  13-10% 但全市场因为2008年起步亏损大(2008净值最差0.58），累计净值不高；  全市场整体胜率39967/102262
	// 参数：  eval 0.9 / 单独评估阀值/ TP——FP RATIO { 1.8, 1.5, 1.2, 1.0, 1.0 }, UPPer{ 0.07, 0.09, 0.11, 0.15, 0.18 } TP_FP_BOTTOM_LINE=0.8
	
	//7. HS300 2008-2016 10-20单元格12%;中证500 20/30/50  6%;全市场20/30/50  12-9% 但全市场因为2008年起步亏损大(2008净值最差0.55），累计净值不高;  全市场整体胜率 38096/97811
	// 参数：  eval 0.7 / 单独评估阀值/ TP——FP RATIO { 1.8, 1.5, 1.2, 1.2, 1.2 }, UPPer{ 0.07, 0.09, 0.1, 0.13, 0.15 } TP_FP_BOTTOM_LINE=0.8
	// lower_limit  { 0.01, 0.01, 0.01, 0.01,0.01 }
	
	//8. HS300 2008-2016 10-20单元格;中证500 20/30/50 ;全市场20/30/50  ;  全市场整体胜率
